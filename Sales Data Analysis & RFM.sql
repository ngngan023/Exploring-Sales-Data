...
--Comment2:
	-- rfm_recency: the smaller number is, the closer the order date is to the max date. It means that the customers numbered 1 are recent buyers, and the ones numbered 4 are long-ago buyers.
